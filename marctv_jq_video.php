...
if (!is_admin()) {
  wp_enqueue_style(
          "jquery.marctv_video", WP_PLUGIN_URL . "/marctv-jq-video/jquery.marctv_video.css",
          false, "1.0");

  wp_enqueue_script(
          "toolbox.flashembed", WP_PLUGIN_URL . "/marctv-jq-video/toolbox.flashembed.min.js",
          array("jquery"), "1.2.5", 0);

  wp_enqueue_script(
          "jquery.marctv_video", WP_PLUGIN_URL . "/marctv-jq-video/jquery.marctv_video.js",
          array("jquery", "toolbox.flashembed"), "1.0", 0);

  wp_enqueue_script(
          "jquery.marctv_videosetup", WP_PLUGIN_URL . "/marctv-jq-video/jquery.marctv_video_setup.js",
